 ...
 * Export Line Model.
 */
class SixBySix_RealTimeDespatch_Model_Export_Line extends Mage_Core_Model_Abstract
{
    /* Line Types */
    ...
    /**
     * Checks whether this is a successful export line.
     *
     * @return boolean
     */
    ...
    /**
     * Checks whether this is a duplicate export line.
     *
     * @return boolean
     */
    ...
    /**
     * Checks whether this is a failed export line.
     *
     * @return boolean
     */
    ...
    {
        $this->setExportId($this->getExport()->getId());
